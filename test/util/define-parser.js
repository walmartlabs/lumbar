...
describe('define-parser', function() {
  ...
  describe('define', function() {
    it('should parse name', function() {
      parser("define('name', [], function() {});").should.eql([
        {name: 'name', deps: [], source: 'function() {}', loc: loc(1, 19, 1, 32), define: true}
      ]);
    });
    ...
    it('should parse deps', function() {
      parser("define('name', ['foo', 'bar'], function() {});").should.eql([
        {name: 'name', deps: ['foo', 'bar'], source: 'function() {}', loc: loc(1, 31, 1, 44), define: true}
      ]);
    });
    it('should support no deps argument', function() {
      parser("define('name', function() {});").should.eql([
        {name: 'name', deps: undefined, source: 'function() {}', loc: loc(1, 15, 1, 28), define: true}
      ]);
    });
  ...
  describe('defineHelper', function() {
    it('should parse', function() {
      parser("defineHelper('name', ['foo'], function() {});").should.eql([
        {'name': 'name', deps: ['foo'], source: 'function() {}', loc: loc(1, 30, 1, 43), helper: true, define: true}
      ]);
    });
  ...
  it('should support multiple declarations', function() {
    parser(
      ...
      {source: "\n", loc: loc(1, 0, 2, 0)},
      {name: 'name', deps: undefined, source: 'function() {}', loc: loc(2, 19, 2, 32), view: true, define: true},
      {source: "\nfoo\n", loc: loc(2, 34, 4, 0)},
      {name: 'name', deps: undefined, source: 'function() {}', loc: loc(4, 15, 4, 28), define: true},
      {source: "foo\nfoo\n", loc: loc(4, 30, 6, 0)},
      {name: 'name', deps: undefined, source: 'function() {}', loc: loc(6, 21, 6, 34), helper: true, define: true},
