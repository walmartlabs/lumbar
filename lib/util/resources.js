...
var resources = module.exports = {
  ...
  map: function(resource, library, config) {
    ...
    if (_.isString(src)) {
      var mixinOverride = library && library.overrides && library.overrides[src],
          libraryOverride = library && library.parent && library.parent.overrides && library.parent.overrides[src],
