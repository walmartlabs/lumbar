...
Libraries.prototype.load = function(context, libraryConfig, callback) {
  ...
  delete libraryConfig.mixins;
      //console.log('loadLibrary', fu.resolvePath(root), _.keys(mixins));
...
Libraries.prototype.mapPathToLibrary = function(src, library) {
  ...
  var mixinRoot = (library.overrideLibrary || library).root || '';
...
// WARN: Deprecated. To be removed in the next incremental version. Use #mapFile instead.
