...
Libraries.prototype.initialize = function(context, callback) {
  ...
  var commandLineLibraries = this.options.libraries || [],
      ...
      bowerLibraries = _.difference(this.bowerLibraries(context) || [], configLibraries),

      allLibraries = commandLineLibraries.concat(configLibraries, bowerLibraries);
...
Libraries.prototype.bowerLibraries = function(context) {
  try {
    ...
    return possibleModules
        .map(function(name) {
          return path.join(bowerDir, name);
        })
