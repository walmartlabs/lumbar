...
function compile(options, callback) {
  ...
  compiler
    .use(pathScopes(context, module, styleConfig))
  ...
  return function(extend) {
    stylus.utils.lookup = function(path, paths, ignore) {
      ...
      if (mixin) {
        ...
        var mixinDecl = _.find(module.mixins, function(mixinDecl) {
              return mixinDecl.name === mixinName.name
    ...
    var mixinPaths = [];
    extend.define('push-mixin', function(name, container) {
      var mixin = {
