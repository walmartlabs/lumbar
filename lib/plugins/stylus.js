...
function compile(files, filename, context, callback) {
      ...
      function mergeResources(start) {
        var generator = function(context, callback) {
          ...
          if (_.isArray(queue)) {
            ...
            compile(generator.stylusFiles, filename, context, function(err, data) {
              if (err) {
                data = undefined;
              }
        ...
        generator.filename = generator.stylusFiles.join(';');
