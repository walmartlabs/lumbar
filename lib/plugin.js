...
exports.create = function(options) {
  ...
  return {
    ...
    moduleResources: function(context, complete) {
      runPluginsAsync(context, 'moduleResources', complete, function() {
    ...
    resourceList: function(context, complete) {
      runPluginsAsync(context, 'resourceList', complete, function() { return [context.resource]; });
    },
    ...
    module: function(context, complete) {
      runPluginsAsync(context, 'module', complete);
    },
    resource: function(context, complete) {
      runPluginsAsync(context, 'resource', complete, function() { return context.resource; });
    }
  };
};
