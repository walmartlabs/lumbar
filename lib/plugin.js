...
const corePlugins = ['scope', 'router', 'template', 'inline-styles', 'stylus', 'module-map', 'package-config', 'inline-styles-resources', 'static-resources', 'styles', 'scripts'];
var globalPlugins = {};
...
exports.plugin('static-resources', require('./plugins/static-resources'));
