...
const corePlugins = ['styles-output', 'scripts-output', 'static-output', 'scope', 'router', 'template', 'inline-styles', 'stylus', 'module-map', 'package-config', 'inline-styles-resources', 'styles', 'scripts', 'static'];
var globalPlugins = {};
      ...
      function plugin(plugins) {
        if (plugins) {
          plugins.forEach(function(plugin) {
            ...
            if (!path || !name) {
              throw new Error("Plugin does not specify 'path' and 'name': " + JSON.stringify(plugin));
            }
