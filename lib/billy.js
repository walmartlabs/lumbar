...
function explodeViews(module, platform, config) {
        ...
        build: function(moduleName, callback) {
            platforms.forEach(function(platform) {
                ...
                modules.forEach(function(name) {
                    var resources = explodeViews(config.modules[name], platform, config),
                        moduleName = outdir + '/' + (platform ? platform + '/' : '') + name + '.js';
                    combine.combine(resources, moduleName, options.minimize, function(err, data) {
                        if (err) {
