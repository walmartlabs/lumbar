    ...
    function buildMode(mode, context, callback) {
      ...
      if (context.fileConfig) {
        ...
        plugins.generatedFiles(context, function(err, configs) {
          // this function is mapped to the complete parameter to 
          // plugins.generatedFiles. we will get called for every 
          // plugin that's registered and is a part of the 
          // current context's mode and has a function 
          // called generated files which in turn 
